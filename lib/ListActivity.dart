    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 246, 85, 11),
          bottom: const TabBar(
            tabs: [
              Tab(text: 'All'),
              Tab(text: 'Basket'),
              Tab(text: 'Board Games'),
            ],
          ),
        ),
        body: ActivityList(),
              ...
              return Column(
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: ['All', 'Basket', 'Board Games'].map((String value) {
